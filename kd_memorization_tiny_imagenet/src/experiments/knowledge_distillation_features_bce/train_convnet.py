...
if __name__ == "__main__":
    ...
    model_name = "kd_convnet_resnet50_conn_bce"
    ...
    teacher_model.load_state_dict(torch.load("../../saved_models/transfer_resnet50_ft_conn_sig_no_act_20230105-232708/checkpoints/100/model.pth")["model_state_dict"])
    
    # load_state_dict(teacher_model, "../../saved_models/resnet50_scratch_weight.pkl")
    # teacher_model.load_state_dict(torch.load("../../saved_models/transfer_resnet50_scratch_conn_sig_no_act_20230105-232649/checkpoints/100/model.pth")["model_state_dict"])
