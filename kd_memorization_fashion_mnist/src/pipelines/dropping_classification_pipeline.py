...
class Pipeline:
    ...
    def train(
        ...
        grad_log1 = np.zeros((100000, self.epochs))
        grad_log2 = np.zeros((100000, self.epochs))
        ...
        for epoch in range(1, self.epochs + 1):
            ...
            for x_train, y_train, idx in pbar:
                ...
                if epoch > drop_epoch:
                    x = x[samples_bitvector[idx] == 1]
                    y_truth = y_truth[samples_bitvector[idx] == 1]
                    idx = idx[samples_bitvector[idx] == 1]
