...
if __name__ == "__main__":
    ...
    low_mem_test_names = [
        "high_conf_0-{}".format(max_mem) for max_mem in [0.1, 0.2, 0.4, 0.6, 0.8]
    ]
    print(["high_conf_subset_0-{}.csv".format(max_mem) for max_mem in [0.1, 0.2, 0.4, 0.6, 0.8]])
    low_mem_part_train_sets = [
        LabeledPickleDatasetMapper(
            cifar_train[b'data'].copy(),
            cifar_train[b'fine_labels'].copy(),
            "high_conf_subset_0-{}.csv".format(max_mem),
            preprocessor,
            augment=False
    ...
    high_mem_test_names = [
        "high_conf_{}-1".format(min_mem) for min_mem in [0.1, 0.2, 0.4, 0.6, 0.8]
    ]
    print(["high_conf_subset_{}-1.csv".format(min_mem) for min_mem in [0.1, 0.2, 0.4, 0.6, 0.8]])
    high_mem_part_train_sets = [
        LabeledPickleDatasetMapper(
            cifar_train[b'data'].copy(),
            cifar_train[b'fine_labels'].copy(),
            "high_conf_subset_{}-1.csv".format(min_mem),
            preprocessor,
            augment=False
